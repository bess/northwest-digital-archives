Feature: Display Pullman Archives files correctly
	...
	Scenario: Check to see that all of the Pullman Archives are loaded
		...
		And I should see the applied filter "Collection" with the value "City of Pullman Collection (1,275)"
	...
	Scenario: Search for Palouse
		Given I am on the homepage
		When I follow "City of Pullman Collection"
		And I fill in "q" with "Palouse"
		And I press "search"
		Then I should get 393 results
	
	Scenario: Search for Paul Henning Collection
		Given I am on the homepage
		When I follow "City of Pullman Collection"
		And I fill in "q" with the phrase "Paul Henning Collection"
		And I press "search"
		Then I should get 365 results
	...
	Scenario: Search for string Theater in Pullman (no quotes)
		Given I am on the homepage
		When I follow "City of Pullman Collection"
		And I fill in "q" with "Theater in Pullman"
		And I press "search"
	...
	Scenario: Search for phrase "Theater in Pullman"
		Given I am on the homepage
		When I follow "City of Pullman Collection"
		And I fill in "q" with the phrase "Theater in Pullman"
		And I press "search"
