...
describe BlacklightMarc do
  ...
  before(:all) do
    ...
    @bl_marc_doc = @hash_with_marcxml
    @bl_marc_doc.extend Blacklight::DocExt::Marc
  ...
  describe "Document" do
    ...
    describe "new" do
      it "should take a Hash as the argument" do
        marcxml_hash = @hash_with_marcxml
        marcxml_hash.extend Blacklight::DocExt::Marc
        lambda { marcxml_hash }.should_not raise_error(ArgumentError)
      end
    end
    ...
    describe "marc_xml method" do
      it "should be nil if marc is blank" do
        ...
        no_marcxml_hash = @hash_without_marcxml
        no_marcxml_hash.extend Blacklight::DocExt::Marc
